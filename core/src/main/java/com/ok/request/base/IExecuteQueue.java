...
public interface IExecuteQueue extends IExecuteRequest {
    ...
    @Override
    IExecuteQueue setUseAutoRetry(boolean useAutoRetry);

    @Override
    IExecuteQueue setAutoRetryTimes(int autoRetryTimes);

    @Override
    IExecuteQueue setAutoRetryInterval(int autoRetryInterval);
